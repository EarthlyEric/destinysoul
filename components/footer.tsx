export default function Footer() {
    const links = [{ name: "EULA", url:"/" }, { name: "Terms of service", url:"/" }, { name: "DestinySoul Assets License", url:"/" }];
    return (
            ...
            <div className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
                <nav className="flex flex-wrap justify-center -mx-5 -my-2">
                    {links.map((item) => (
                        <div className="px-5 py-2" key={item.name}>
                            <a href={item.url} className="text-base leading-6 text-gray-500 hover:text-gray-900">
                                {item.name}
                            </a>
                        </div>
                    ))}
                ...
                <div className="flex justify-center mt-8 space-x-6">
                    {[
                        ...
                        <a href="#" className="text-gray-400 hover:text-gray-500" key={social.name}>
                ...
                <p className="mt-8 text-base leading-6 text-center text-gray-400">
                    © 2024 ~ 2025 DestinySoul Studio. All rights reserved.
                </p>
            </div>
        </div>
    );
